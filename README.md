...
All CLI tools are available via the [saiden-dev/tap](https://github.com/saiden-dev/homebrew-tap) Homebrew tap for macOS and Linux. After tapping, install any package with a single command.
